package in.co.b2bhub.www.recordingapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonStop = (Button) findViewById(R.id.play_button);
        buttonPlayLastRecordAudio = (Button) findViewById(R.id.stop_button);
        buttonStopPlayingRecording = (Button) findViewById(R.id.stop_playing_button);
